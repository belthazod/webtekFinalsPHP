...
try {
   $conn = new PDO("mysql:host=$host;dbname=$dbname", $user, $pass); //MYSQL database
...
$nRows=$conn->query("SELECT count(*) from class natural join course WHERE $where")->fetchColumn();   /* specific search then how many match */
